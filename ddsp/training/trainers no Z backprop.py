...
class Trainer(object):
  ...
  def step_fn(self, batch):
    ...
    m_vars8 = [var for var in tvars if '/fc_stack_6/' in var.name]
    ...
    l_vars5 = [var for var in tvars if '/fc_stack_2/' in var.name]
    l_vars6 = [var for var in tvars if '/fc_stack_3/' in var.name]
    l_vars8 = [var for var in tvars if '/fc_stack_7/' in var.name]
    ...
    r_vars5 = [var for var in tvars if '/fc_stack_4/' in var.name]
    r_vars6 = [var for var in tvars if '/fc_stack_5/' in var.name]
    r_vars8 = [var for var in tvars if '/fc_stack_8/' in var.name]
